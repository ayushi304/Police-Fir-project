	...
	protected void doPost(HttpServletRequest request,
		...
		Blob b1 = null;
				...
				for (FileItem item : items) {
					...
					if (n.equals("ComplaintId")) {
						ComplaintId = item.getString();
					} else if (n.equals("StationName")) {
				...
				ComplaintForm cf = new ComplaintForm(ComplaintId, StationName, Complaintype, DateOfIncident,TimeOfIncident,District,WriteComplain
						, PlaceOfOccurence, Name, mob, Email, hno, City,
				  b1, State,pincode);
			...
			/*	PrintWriter out = response.getWriter();
				out.println("<html>");
				out.println("<body>");
				out.println("<h3>Complain-Form</h3>");
